...
<template>
  <div class="overflow-x-auto grid gap-2">
        ...
        <tr>
          ...
          <td>
            <div class="flex items-center gap-3">
              <div class="avatar">
                <div class="h-12 w-12">
                  <img src="/img/normal_native_copper.png" alt="Copper" style="image-rendering: pixelated" />
                </div>
              </div>
              <div class="font-bold">Copper</div>
            </div>
          </td>
          <td>
